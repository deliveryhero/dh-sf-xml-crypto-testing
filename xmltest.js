...
const main = async() => {
    const myDoc = await decryptXml(PAYLOAD, DECRYPTION_PRIV_KEY);
    // console.log('####### decDoc', decDoc);
	...
	sig.keyInfoProvider = new xmlcrypto.FileKeyInfo(SIGNATURE_PUBLIC_KEY_PATH);
